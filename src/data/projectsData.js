export const projectsData = [
  {
    id: 1,
    title: "Business Waitlist App",
    tags: ["React", "Firebase", "CSS"],
    description: "The business waitlist app is a real-time queue management system that allows businesses to create and manage customer waitlists while enabling customers to join queues remotely and track their position. Business owners can control the flow of customers by adding, serving, or removing people from the queue, while customers can see estimated wait times and live progress updates. The app uses Firebase for authentication and real-time data handling, ensuring secure access, instant updates, and smooth coordination between businesses and customers.",
    image: process.env.PUBLIC_URL + "/image/business-waitlist-app.png",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/Screenshot (136).png",
    github: "https://github.com/KachiTechboss/Chuba-portfolio",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/social media dashboard.webp",
    github: "https://github.com/KachiTechboss/Socialmedia-Dashboard",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/dental.jpg",
    github: "https://github.com/KachiTechboss/SpineCare-Dental-Clinic",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/flyo pics.webp",
    github: "https://github.com/KachiTechboss/flyo-dark-theme",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/product-list pics.webp",
    github: "https://github.com/KachiTechboss/product-list",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/real estate firm.webp",
    github: "https://github.com/KachiTechboss/real-estate-demo-site",
  ...
  },
  {
    ...
    image: process.env.PUBLIC_URL + "/image/time dasboaerd pics.webp",
